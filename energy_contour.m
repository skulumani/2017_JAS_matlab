...
text(l_scale*L1(1),0, '$L_1$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')
text(l_scale*L2(1),0, '$L_2$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')
text(l_scale*L3(1),0, '$L_3$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')
text(l_scale*L4(1),l_scale*L4(2), '$L_4$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')
...
text(primary_1(1),primary_1(2), '$m_1$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')
text(primary_2(1),primary_2(2), '$m_2$','HorizontalAlignment','Center','VerticalAlignment','Bottom','interpreter','latex','FontUnits','points','FontSize',15,'FontName','Times')