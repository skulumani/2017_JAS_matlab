...
function [t, state, u] = pcrtbp_fixed_tf_varying_um(xc0, xcf, tf, um)
...
% tspan = [0 1.3075]; % L1 transfer final working
% tspan = [0 0.355837553671024]; % geo transfer final working
...
% xc0 = [0.815614054266804 0 0 0.192227407664904]'; % L1 reach transfer working
...
% constants.xcf = [0.927258145099694 0  -0.036751604638168 -0.369096025781395]; % L1 reach transfer final working
% constants.xcf = [ 0.175319307882103 -0.000000000000020 -0.282163264918425 2.717676740320596]; % geo transfer final working
